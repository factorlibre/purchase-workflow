...
#    Copyright (C) 2016 FactorLibre (<http://www.factorlibre.com>).
#    @author Janire Olagibel <janire.olagibel@factorlibre.com>
#
...
class PurchaseOrderLine(models.Model):
    ...
    def _get_real_qty_available(self, field_names=None):
        for line in self:
            ...
            ctx['warehouse'] = line.order_id.picking_type_id.warehouse_id.id
