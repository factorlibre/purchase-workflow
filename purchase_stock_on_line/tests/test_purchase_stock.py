...
class TestPurchaseOrder(common.TransactionCase):
    ...
    def test_purchase_order_vals(self):
        ...
        self.assertEqual(product1.virtual_available, 0.0)
        self.assertEqual(product1.qty_available, 0.0)

        self._product_change_qty(product1, 30)
        self.assertEqual(self.po_line_1.virtual_available, 30.0)
        self.assertEqual(self.po_line_1.qty_available, 30.0)
        ...
        self.assertEqual(product2.virtual_available, 4.0)
        self.assertEqual(product2.qty_available, 4.0)

        self.assertEqual(self.po_line_2.virtual_available, 4.0)
        self.assertEqual(self.po_line_2.qty_available, 4.0)
